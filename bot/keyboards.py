...
def start_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Принимаю риски, поехали!", callback_data="accept_terms")],
    ])
...
def main_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="Запустить", callback_data="start_bot"),
...
def settings_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Стратегия AI", callback_data="set_trader")],
...
def trader_preset_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Консервативный (низкий риск)", callback_data="preset_conservative")],
        [InlineKeyboardButton(text="Сбалансированный (средний риск)", callback_data="preset_balanced")],
        [InlineKeyboardButton(text="Агрессивный (высокий риск)", callback_data="preset_aggressive")],
...
def mode_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Демо (виртуальные деньги)", callback_data="mode_paper")],
        [InlineKeyboardButton(text="Реальная торговля (настоящие деньги)", callback_data="mode_live")],
        [InlineKeyboardButton(text="Назад", callback_data="settings")],
    ])
...
def confirm_live_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Да, я понимаю риски", callback_data="confirm_live")],
        [InlineKeyboardButton(text="Нет, остаться на демо", callback_data="mode_paper")],
    ])
...
def notifications_kb(settings: dict) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(
            text=f"Новые сделки: {icon(settings.get('notify_new_trade', 1))}",
            callback_data="toggle_notify_new_trade")],
        [InlineKeyboardButton(
            text=f"Закрытие сделок: {icon(settings.get('notify_close_trade', 1))}",
            callback_data="toggle_notify_close_trade")],
        [InlineKeyboardButton(
            text=f"Стоп-лосс: {icon(settings.get('notify_sl_hit', 1))}",
            callback_data="toggle_notify_sl_hit")],
        [InlineKeyboardButton(
            text=f"Дневной отчёт: {icon(settings.get('notify_daily_report', 1))}",
            callback_data="toggle_notify_daily_report")],
        [InlineKeyboardButton(
            text=f"Ошибки: {icon(settings.get('notify_errors', 1))}",
